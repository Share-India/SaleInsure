        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
            <div className="bg-white rounded-3xl w-full max-w-3xl shadow-2xl flex flex-col max-h-[90vh]">
                ...
                <div className="px-8 py-4 border-b border-slate-100 flex justify-between items-center shrink-0">
                    <div>
                        <h2 className="text-xl font-bold text-slate-900">Deal History: {clientName}</h2>
                        <p className="text-sm text-slate-500 mt-1">Full chronological timeline of interactions</p>
                    </div>
                                            ...
                                            <div className="flex justify-between items-start mb-4">
                                                <div>
                                                    ...
                                                    <h3 className="text-base font-bold text-slate-900 flex items-center gap-2">
                                                        ...
                                                        <span className="text-slate-400 font-normal text-sm">logged on {dateString}</span>
                                                    </h3>
                                                </div>
